        ...
        try {
            ...
            if (createdMembershipId) {
                await serviceSupabase
                    ...
                    .then(undefined, (err) => console.error("Rollback membership delete error:", err));
            }

            if (createdPrimaryUserId) {
                await serviceSupabase.auth.admin
                    .deleteUser(createdPrimaryUserId)
                    .then(undefined, (err) => console.error("Rollback auth user delete error:", err));
            }
            ...
            if (createdCustomerId) {
                await serviceSupabase
                    ...
                    .then(undefined, (err) => console.error("Rollback customer delete error:", err));
            }
