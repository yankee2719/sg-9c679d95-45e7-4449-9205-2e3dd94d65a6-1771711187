  ...
  > ([]);
    ...
    const load = async () => {
        ...
        try {
            ...
            // ✅ carica assignments includendo l'ID della riga
    ...
    const revokeAssignment = async (assignmentId: string, machineName: string) => {
        ...
        try {
            ...
            toast({ title: "OK", description: "Assegnazione rimossa" });
                                                ...
                                                <div className="flex gap-2 shrink-0">
                                                    ...
                                                    {canEdit && (
                                                        <Button
                                                            variant="destructive"
                                                            size="sm"
                                                            onClick={() => revokeAssignment(a.id, a.machine?.name ?? "macchina")}
                                                        >
