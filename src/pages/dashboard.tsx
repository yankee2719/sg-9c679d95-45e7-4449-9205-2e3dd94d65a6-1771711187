...
const copy = {
    it: {
        ...
        activity_customer_user_membership_create: "Utente cliente aggiunto",
        activity_customer_user_membership_update: "Utente cliente aggiornato",
    ...
    en: {
        ...
        activity_customer_user_membership_create: "Customer user added",
        activity_customer_user_membership_update: "Customer user updated",
    ...
    fr: {
        ...
        activity_customer_user_membership_create: "Utilisateur client ajouté",
        activity_customer_user_membership_update: "Utilisateur client mis à jour",
    ...
    es: {
        ...
        activity_customer_user_membership_create: "Usuario de cliente añadido",
        activity_customer_user_membership_update: "Usuario de cliente actualizado",
