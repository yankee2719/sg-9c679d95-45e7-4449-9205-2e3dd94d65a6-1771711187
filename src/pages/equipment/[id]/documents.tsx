            ...
            <div className="mx-auto max-w-6xl space-y-6 px-4 py-6 lg:px-8 lg:py-8">
                <div>
                    ...
                    <div className="space-y-2">
                        <h1 className="flex items-center gap-3 text-2xl font-bold text-foreground lg:text-3xl">
                            ...
                            {t("equipment.docManagement") || "Document management"}
                        </h1>
                        <p className="text-sm text-muted-foreground lg:text-base">
                            {machine ? `${machine.name} · ${secondaryCode}` : t("equipment.machineNotFound") || "Machine not found"}
                        </p>
                    </div>
                </div>
                ...
                <div className="rounded-2xl border border-blue-500/20 bg-blue-500/10 p-6">
                    ...
                    <ul className="space-y-1 text-sm text-blue-600 dark:text-blue-200">
                        ...
                        <li>• {t("equipment.docTip3") || "Add a clear change summary when uploading a new version."}</li>
                        <li>• {t("equipment.docTip4") || "Preserve version history for auditability and compliance."}</li>
                    </ul>
                </div>
            </div>
        </MainLayout>
