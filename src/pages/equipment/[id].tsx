...
export default function EquipmentDetailPage() {
  ...
  // ✅ ROUTE GUARD: se qualcuno arriva qui con /equipment/new (o /equipment/edit)
  useEffect(() => {
  ...
  const machineId = useMemo(() => {
    ...
    if (id === "new" || id === "edit") return null; // già gestiti sopra
    return id;
  }, [id]);
  ...
  if (id === "new") return null; // mentre redirecta
          ...
          <TabsContent value="details" className="mt-4">
            <Card className="rounded-2xl border-0 bg-card shadow-sm">
              ...
              <CardContent className="space-y-2 text-sm">
                ...
                <div>
                  <b>ID:</b> <span className="font-mono">{machine.id}</span>
                </div>
              </CardContent>
            </Card>
          </TabsContent>
