              ...
              <div className="flex flex-col gap-4 xl:flex-row">
                ...
                {orgType === "customer" && (
                  ...
                  >
                    ...
                    {showHidden
                      ? t("equipment.hideLocalArchived")
                      : t("equipment.showHidden")}
                  </button>
                )}
              </div>
            </CardShell>
                        ...
                        <CardShell className="p-5 transition hover:-translate-y-0.5">
                          <div className="space-y-4">
                              ...
                              <div className="flex min-w-0 items-center gap-4">
                                ...
                                <div className="min-w-0">
                                  <div className="truncate text-xl font-semibold text-foreground">
                                    {machine.name ?? t("equipment.machineFallback")}
                                  </div>
                            ...
                            <div className="flex flex-wrap gap-2">
                              {isOwner && (
                                <span className="rounded-full bg-blue-500/15 px-3 py-1 text-sm font-semibold text-blue-700 dark:text-blue-300">
                                  {t("equipment.badge.owned")}
                                </span>
                              )}
                              {isAssigned && (
                                <span className="rounded-full bg-emerald-500/15 px-3 py-1 text-sm font-semibold text-emerald-700 dark:text-emerald-300">
                                  {t("equipment.badge.assigned")}
                                </span>
                              )}
                              {machine.lifecycle_state && (
                                <span className="rounded-full border border-border bg-muted px-3 py-1 text-sm font-semibold text-foreground/85">
                                  {machine.lifecycle_state}
                                </span>
                              )}
                              {machine.is_archived && (
                                <span className="rounded-full bg-red-500/15 px-3 py-1 text-sm font-semibold text-red-700 dark:text-red-300">
                                  {t("equipment.badge.archived")}
                                </span>
                              )}
                            </div>
