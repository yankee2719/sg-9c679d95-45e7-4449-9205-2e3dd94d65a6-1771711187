                    ...
                    <div className="mx-auto max-w-[1440px] space-y-6">
                        <div className="flex items-start justify-between gap-4">
                            ...
                            <Link
                                ...
                                className="inline-flex items-center gap-3 rounded-2xl border border-border bg-card px-5 py-3 font-semibold text-foreground transition hover:bg-accent"
                            >
                        ...
                        <div className="w-full max-w-[520px] rounded-2xl border border-border bg-muted/60 p-1">
                            <div className="grid grid-cols-2 gap-1">
                                <button className="rounded-2xl bg-background px-4 py-2.5 font-semibold text-foreground">
                                    Piani
                                </button>
                                <button className="rounded-2xl px-4 py-2.5 font-semibold text-muted-foreground">
                                    Ordini di Lavoro
                                </button>
                            </div>
                        </div>
                        ...
                        <CardShell className="p-5">
                            <div className="flex flex-col gap-4 xl:flex-row">
                                ...
                                <div className="flex h-12 items-center gap-3 rounded-2xl border border-border bg-background px-4 text-foreground xl:w-[180px]">
