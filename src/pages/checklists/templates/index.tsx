    ...
    useEffect(() => {
        const load = async () => {
            try {
                ...
                const templateIds = (data ?? []).map((row: any) => row.id);
    ...
    const filteredRows = useMemo(() => {
        return rows.filter((row) => {
            ...
            const normalizedTarget =
                row.target_type === "production_line" ? "production_line" : "machine";
                ...
                <div className="mx-auto max-w-[1440px] space-y-8">
                    ...
                    <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-3">
                        ...
                        <CardShell className="p-6">
                            ...
                            <div className="text-5xl font-bold leading-none text-foreground">{stats.active}</div>
                            <div className="mt-2 text-[22px] font-medium text-muted-foreground">
                                                ...
                                                <div className="flex min-w-0 items-center gap-4">
                                                    ...
                                                    <div className="min-w-0">
                                                        ...
                                                        <div className="mt-1 flex flex-wrap items-center gap-x-4 gap-y-1 text-lg text-muted-foreground">
                                                            ...
                                                            <span>
                                                                {row.is_active ? text.templates.statusActive : text.templates.statusInactive}
                                                            </span>
