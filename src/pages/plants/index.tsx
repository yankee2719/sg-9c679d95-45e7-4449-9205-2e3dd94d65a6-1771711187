              ...
              <div key={plant.id} className="rounded-2xl border border-blue-500/30 bg-card/50 overflow-hidden">
                ...
                <div className="flex items-center justify-between px-5 py-4">
                  <button onClick={() => togglePlant(plant.id)} className="flex items-center gap-3 flex-1">
                    ...
                    <Badge className="bg-blue-500/20 text-blue-400 border-blue-500/30 ml-3">
                ...
                {isExpanded && (
                  <div className="px-5 pb-4 space-y-3 ml-8">
                    {/* Existing lines */}
                    {plantLines.map(line => (
                      <div key={line.id} className="flex items-center justify-between p-3 rounded-xl border border-amber-500/20 bg-card/60">
                    ...
                    {showLineForm === plant.id && isAdmin ? (
                      <div className="p-3 rounded-xl border border-amber-500/30 bg-card/40 space-y-3">
