...
const translations: Record<Language, Record<string, string>> = {
    ...
    en: {
        "common.loading": "Loading...", "common.save": "Save", "common.cancel": "Cancel", "common.delete": "Delete", "common.edit": "Edit", "common.create": "Create", "common.search": "Search", "common.filter": "Filter", "common.export": "Export", "common.back": "Back", "common.next": "Next", "common.confirm": "Confirm", "common.close": "Close", "common.yes": "Yes", "common.no": "No", "common.all": "All", "common.none": "None", "common.actions": "Actions", "common.status": "Status", "common.date": "Date", "common.time": "Time", "common.name": "Name", "common.description": "Description", "common.notes": "Notes", "common.priority": "Priority", "common.high": "High", "common.medium": "Medium", "common.low": "Low", "common.success": "Success", "common.error": "Error", "common.warning": "Warning", "common.never": "Never", "common.noDescription": "No description", "common.show": "Show", "common.clickToShow": "Click to show",
        ...
        "equipment.title": "Equipment", "equipment.subtitle": "Manage and monitor all equipment", "equipment.new": "New Equipment", "equipment.noEquipment": "No equipment found", "equipment.generic": "Generic", "equipment.noLocation": "Location not specified", "equipment.active": "Active", "equipment.inactive": "Inactive", "equipment.maintenance": "Under Maintenance", "equipment.decommissioned": "Decommissioned",
        "checklists.title": "Checklists", "checklists.active": "Active", "checklists.inactive": "Inactive", "checklists.items": "items", "checklists.noChecklists": "No checklists found",
        "users.title": "User Management", "users.admin": "Administrator", "users.technician": "Technician", "users.supervisor": "Supervisor", "users.viewer": "Viewer",
        "settings.title": "Settings", "settings.profile": "Profile", "settings.security": "Security", "settings.notifications": "Notifications", "settings.appearance": "Appearance", "settings.language": "Language", "settings.theme": "Theme", "settings.darkMode": "Dark Mode", "settings.lightMode": "Light Mode",
        ...
        "notifications.title": "Notifications", "notifications.markAllRead": "Mark all as read", "notifications.noNotifications": "No notifications", "notifications.new": "New",
        "analytics.title": "Analytics", "analytics.checklistExecutions": "Checklist Executions",
        "auth.login": "Login", "auth.logout": "Logout", "auth.email": "Email", "auth.password": "Password",
        "scanner.title": "QR Scanner", "scanner.scan": "Scan",
    },
    fr: {
        "common.loading": "Chargement...", "common.save": "Enregistrer", "common.cancel": "Annuler", "common.delete": "Supprimer", "common.edit": "Modifier", "common.all": "Tous", "common.success": "Succès", "common.error": "Erreur",
        ...
        "dashboard.welcome": "Bienvenue", "dashboard.totalEquipment": "Équipements Totaux", "dashboard.upcomingMaintenance": "Prochaines Maintenances", "dashboard.overdueItems": "Maintenances en Retard", "dashboard.scanQR": "Scanner QR", "dashboard.viewAll": "Voir Tout",
        "equipment.title": "Équipements", "equipment.noEquipment": "Aucun équipement trouvé", "equipment.generic": "Générique", "equipment.noLocation": "Emplacement non spécifié",
        "checklists.title": "Checklists", "checklists.active": "Active", "checklists.inactive": "Inactive", "checklists.items": "éléments",
        "users.title": "Gestion des Utilisateurs", "users.admin": "Administrateur", "users.technician": "Technicien", "users.supervisor": "Superviseur",
        "settings.title": "Paramètres", "settings.language": "Langue",
        "maintenance.title": "Maintenance", "maintenance.completed": "Terminée",
        "notifications.title": "Notifications", "notifications.noNotifications": "Aucune notification",
        "analytics.title": "Analyses",
        "auth.login": "Connexion", "auth.email": "Email", "auth.password": "Mot de passe",
        "scanner.title": "Scanner QR",
    },
    es: {
        "common.loading": "Cargando...", "common.save": "Guardar", "common.cancel": "Cancelar", "common.delete": "Eliminar", "common.edit": "Editar", "common.all": "Todos", "common.success": "Éxito", "common.error": "Error",
        ...
        "dashboard.welcome": "Bienvenido", "dashboard.totalEquipment": "Equipos Totales", "dashboard.upcomingMaintenance": "Próximos Mantenimientos", "dashboard.overdueItems": "Mantenimientos en Retraso", "dashboard.scanQR": "Escanear QR", "dashboard.viewAll": "Ver Todo",
        "equipment.title": "Equipos", "equipment.noEquipment": "No se encontraron equipos", "equipment.generic": "Genérico", "equipment.noLocation": "Ubicación no especificada",
        "checklists.title": "Checklist", "checklists.active": "Activa", "checklists.inactive": "Inactiva", "checklists.items": "elementos",
        "users.title": "Gestión de Usuarios", "users.admin": "Administrador", "users.technician": "Técnico", "users.supervisor": "Supervisor",
        "settings.title": "Configuración", "settings.language": "Idioma",
        "maintenance.title": "Mantenimiento", "maintenance.completed": "Completado",
        "notifications.title": "Notificaciones", "notifications.noNotifications": "Sin notificaciones",
        "analytics.title": "Análisis",
        "auth.login": "Iniciar Sesión", "auth.email": "Correo Electrónico", "auth.password": "Contraseña",
...
export function LanguageProvider({ children }: { children: ReactNode }) {
    // Start with null — render nothing until we read localStorage on client
    const [language, setLanguageState] = useState < Language | null > (null);

    useEffect(() => {
        const saved = localStorage.getItem("app-language") as Language | null;
        setLanguageState(saved && translations[saved] ? saved : "it");
    }, []);
    ...
    // Don't render children until language is known — avoids hydration mismatch
