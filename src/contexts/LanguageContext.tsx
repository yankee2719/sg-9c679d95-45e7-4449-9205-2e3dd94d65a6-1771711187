...
const translations: Record<Language, Record<string, string>> = {
    it: {
        ...
        "equipment.quickActions": "Azioni rapide",
        "equipment.openMaintenance": "Vai a manutenzione",
        "equipment.openDocuments": "Apri documenti",
        "equipment.openTimeline": "Apri timeline",
        "equipment.qrScanner": "Scanner QR",
        "equipment.checkSecurity": "Controlla sicurezza",
        "equipment.manageList": "Gestisci elenco macchine",
        ...
        "equipment.notFoundDesc": "La macchina richiesta non esiste.",
        "equipment.accessDenied": "Accesso negato",
        "equipment.accessDeniedDesc": "La macchina non è disponibile nel contesto attivo.",
        "equipment.loadError": "Errore caricamento.",
        "equipment.createdOn": "Creata il",
        "equipment.noInternalCode": "Codice non definito",
        "equipment.noSerialNumber": "Matricola non definita",
    ...
    en: {
        ...
        "equipment.editMachine": "Edit machine",
        "equipment.moveToTrash": "Move to trash",
        "equipment.photo": "Machine photo",
        "equipment.photoDesc": "Main machine image.",
        "equipment.quickActions": "Quick actions",
        "equipment.openMaintenance": "Go to maintenance",
        "equipment.openDocuments": "Open documents",
        "equipment.openTimeline": "Open timeline",
        "equipment.qrScanner": "QR scanner",
        "equipment.checkSecurity": "Check security",
        "equipment.manageList": "Manage machine list",
        "equipment.quickInfo": "Quick information",
        "equipment.internalCode": "Internal code",
        "equipment.assignedCustomer": "Assigned customer",
        "equipment.owner": "Owner",
        "equipment.notes": "Machine notes",
        "equipment.notesDesc": "Operational information and contextual notes.",
        "equipment.noNotes": "No notes available.",
        "equipment.timeline": "Machine timeline",
        "equipment.timelineDesc": "Events, edits and operational history.",
        "equipment.docsDesc": "Technical archive linked to the machine.",
        "equipment.machineContext": "Machine context",
        "equipment.ownerContext": "Owner context",
        "equipment.assignmentContext": "Assignment context",
        "equipment.notAssigned": "Not assigned",
        "equipment.deleteConfirm": "Move the machine to trash?",
        "equipment.movedToTrash": "Machine moved to trash",
        "equipment.notFound": "Machine not found",
        "equipment.notFoundDesc": "The requested machine does not exist.",
        "equipment.accessDenied": "Access denied",
        "equipment.accessDeniedDesc": "The machine is not available in the active context.",
        "equipment.loadError": "Loading error.",
        "equipment.createdOn": "Created on",
        "equipment.noInternalCode": "Internal code not set",
        "equipment.noSerialNumber": "Serial number not set",
    ...
    fr: {
        ...
        "equipment.editMachine": "Modifier la machine",
        "equipment.moveToTrash": "Déplacer dans la corbeille",
        "equipment.photo": "Photo de la machine",
        "equipment.photoDesc": "Image principale de la machine.",
        "equipment.quickActions": "Actions rapides",
        "equipment.openMaintenance": "Aller à la maintenance",
        "equipment.openDocuments": "Ouvrir les documents",
        "equipment.openTimeline": "Ouvrir la chronologie",
        "equipment.qrScanner": "Scanner QR",
        "equipment.checkSecurity": "Vérifier la sécurité",
        "equipment.manageList": "Gérer la liste des machines",
        "equipment.quickInfo": "Informations rapides",
        "equipment.internalCode": "Code interne",
        "equipment.assignedCustomer": "Client affecté",
        "equipment.owner": "Propriétaire",
        "equipment.notes": "Notes de la machine",
        "equipment.notesDesc": "Informations opérationnelles et notes contextuelles.",
        "equipment.noNotes": "Aucune note disponible.",
        "equipment.timeline": "Chronologie machine",
        "equipment.timelineDesc": "Événements, modifications et historique opérationnel.",
        "equipment.docsDesc": "Archive technique liée à la machine.",
        "equipment.machineContext": "Contexte machine",
        "equipment.ownerContext": "Contexte propriétaire",
        "equipment.assignmentContext": "Contexte d’affectation",
        "equipment.notAssigned": "Non affectée",
        "equipment.deleteConfirm": "Déplacer la machine dans la corbeille ?",
        "equipment.movedToTrash": "Machine déplacée dans la corbeille",
        "equipment.notFound": "Machine introuvable",
        "equipment.notFoundDesc": "La machine demandée n’existe pas.",
        "equipment.accessDenied": "Accès refusé",
        "equipment.accessDeniedDesc": "La machine n’est pas disponible dans le contexte actif.",
        "equipment.loadError": "Erreur de chargement.",
        "equipment.createdOn": "Créée le",
        "equipment.noInternalCode": "Code interne non défini",
        "equipment.noSerialNumber": "Numéro de série non défini",
        ...
        "machines.serialNumber": "Numéro de série",
        "machines.model": "Modèle",
        "machines.manufacturer": "Constructeur",
        "machines.status": "État",
    ...
    es: {
        ...
        "equipment.editMachine": "Editar máquina",
        "equipment.moveToTrash": "Mover a la papelera",
        "equipment.photo": "Foto de la máquina",
        "equipment.photoDesc": "Imagen principal de la máquina.",
        "equipment.quickActions": "Acciones rápidas",
        "equipment.openMaintenance": "Ir a mantenimiento",
        "equipment.openDocuments": "Abrir documentos",
        "equipment.openTimeline": "Abrir cronología",
        "equipment.qrScanner": "Escáner QR",
        "equipment.checkSecurity": "Comprobar seguridad",
        "equipment.manageList": "Gestionar lista de máquinas",
        "equipment.quickInfo": "Información rápida",
        "equipment.internalCode": "Código interno",
        "equipment.assignedCustomer": "Cliente asignado",
        "equipment.owner": "Propietario",
        "equipment.notes": "Notas de la máquina",
        "equipment.notesDesc": "Información operativa y notas contextuales.",
        "equipment.noNotes": "No hay notas disponibles.",
        "equipment.timeline": "Cronología de la máquina",
        "equipment.timelineDesc": "Eventos, cambios e historial operativo.",
        "equipment.docsDesc": "Archivo técnico vinculado a la máquina.",
        "equipment.machineContext": "Contexto de la máquina",
        "equipment.ownerContext": "Contexto del propietario",
        "equipment.assignmentContext": "Contexto de asignación",
        "equipment.notAssigned": "No asignada",
        "equipment.deleteConfirm": "¿Mover la máquina a la papelera?",
        "equipment.movedToTrash": "Máquina movida a la papelera",
        "equipment.notFound": "Máquina no encontrada",
        "equipment.notFoundDesc": "La máquina solicitada no existe.",
        "equipment.accessDenied": "Acceso denegado",
        "equipment.accessDeniedDesc": "La máquina no está disponible en el contexto activo.",
        "equipment.loadError": "Error de carga.",
        "equipment.createdOn": "Creada el",
        "equipment.noInternalCode": "Código interno no definido",
        "equipment.noSerialNumber": "Número de serie no definido",
        ...
        "machines.serialNumber": "Número de serie",
        "machines.model": "Modelo",
        "machines.manufacturer": "Fabricante",
