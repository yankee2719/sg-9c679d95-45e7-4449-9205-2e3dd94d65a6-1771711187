...
const translationFallbacks: Record<Language, Record<string, string>> = {
    it: {
        ...
        "equipment.createPlantsCta": "Apri stabilimenti",
        "equipment.createSubtitle": "Crea una nuova macchina nel contesto attivo.",
        "equipment.created": "Macchina creata",
        "equipment.deleteConfirm": "Vuoi davvero archiviare questa macchina?",
        "equipment.docsDesc": "Manuali, schemi, dichiarazioni e allegati macchina.",
        "equipment.editMachine": "Modifica macchina",
        "equipment.editSubtitle": "Aggiorna dati tecnici e contesto organizzativo della macchina.",
        "equipment.forbidden": "Questa pagina non è disponibile nel contesto attivo.",
        "equipment.genericSaveError": "Errore durante il salvataggio della macchina",
        "equipment.internalCode": "Codice interno",
        "equipment.lifecycle.active": "Attiva",
        "equipment.lifecycle.commissioning": "In commissioning",
        "equipment.lifecycle.decommissioned": "Dismessa",
        "equipment.lifecycle.inactive": "Inattiva",
        "equipment.lifecycle.maintenance": "In manutenzione",
        "equipment.loadError": "Errore caricamento macchina",
        "equipment.mainData": "Dati principali",
        "equipment.manageList": "Gestisci elenco",
        "equipment.machineContext": "Contesto macchina",
        "equipment.moveToTrash": "Archivia macchina",
        "equipment.movedToTrash": "Macchina archiviata",
        "equipment.name": "Nome macchina *",
        "equipment.noNotes": "Nessuna nota disponibile.",
        "equipment.noPlantsAvailable": "Non risultano stabilimenti nel contesto attivo.",
        "equipment.notes": "Note",
        "equipment.notesDesc": "Informazioni operative e note interne sulla macchina.",
        "equipment.notAssigned": "Non assegnata",
        "equipment.openDocuments": "Apri documenti",
        "equipment.openMaintenance": "Apri manutenzione",
        "equipment.openTimeline": "Apri timeline",
        "equipment.organizationContext": "Contesto organizzativo",
        "equipment.owner": "Organizzazione attiva",
        "equipment.ownerContext": "Contesto proprietario",
        "equipment.photo": "Foto macchina",
        "equipment.photoDesc": "Immagine di copertina e documentazione fotografica.",
        "equipment.placeholderName": "Es. HMS 140",
        "equipment.qrScanner": "Scanner QR",
        "equipment.quickActions": "Azioni rapide",
        "equipment.quickInfo": "Informazioni rapide",
        "equipment.requiredName": "Il nome macchina è obbligatorio.",
        ...
        "workOrders.createLoading": "Stiamo preparando il contesto operativo...",
        "workOrders.descriptionPlaceholder": "Descrizione intervento, sintomi, note operative...",
        "workOrders.dueDate": "Scadenza",
        "workOrders.errorCreate": "Errore creazione work order",
        "workOrders.errorInvalidMachine": "Macchina selezionata non valida.",
        "workOrders.errorLoadPage": "Errore caricamento pagina",
        "workOrders.errorNoPlant": "La macchina selezionata non ha uno stabilimento associato.",
        "workOrders.errorSelectMachine": "Seleziona una macchina.",
        "workOrders.errorTitleRequired": "Inserisci il titolo.",
        ...
        "workOrders.onlyAdminCreate": "Non hai i permessi per creare work order.",
        "workOrders.overdue": "Scaduti",
        "workOrders.permissionDenied": "Permesso negato",
        "workOrders.redirectDesc": "Ti stiamo portando al nuovo flusso work order.",
        ...
        "workOrders.titlePlaceholder": "es. Sostituzione cuscinetto lato motore",
    ...
    en: {
        ...
        "plants.customerOnly": "This section is available only in customer context.",
        "plants.emptyTitle": "No plants found",
        "plants.emptyDesc": "Create the first plant to organize machines and production lines.",
        "plants.lines": "Lines",
        "plants.line": "Line",
        "plants.machinesPlaced": "Placed machines",
        "plants.plantsWithMachines": "Plants with machines",
        "equipment.quickActions": "Quick actions",
        "equipment.openMaintenance": "Open maintenance",
        "equipment.openDocuments": "Open documents",
        "equipment.openTimeline": "Open timeline",
        "equipment.qrScanner": "QR scanner",
        "equipment.manageList": "Manage list",
        "workOrders.assignedTo": "Assign to",
        "workOrders.unassigned": "Unassigned",
        "workOrders.dueDate": "Due date",
        "workOrders.statusDraft": "Draft",
        "workOrders.statusScheduled": "Scheduled",
        "workOrders.statusPendingReview": "Pending review",
        "workOrders.statusCancelled": "Cancelled",
        "workOrders.saveWorkOrder": "Save work order",
        "workOrders.selectMachine": "Select machine",
    },
    fr: {
        "common.error": "Erreur",
        ...
        "equipment.openMaintenance": "Ouvrir maintenance",
        "equipment.openDocuments": "Ouvrir documents",
        "equipment.openTimeline": "Ouvrir chronologie",
        "equipment.qrScanner": "Scanner QR",
        "workOrders.assignedTo": "Attribuer à",
        "workOrders.unassigned": "Non attribué",
        "workOrders.dueDate": "Échéance",
        "workOrders.statusDraft": "Brouillon",
        "workOrders.statusScheduled": "Planifié",
        "workOrders.statusPendingReview": "En révision",
        "workOrders.statusCancelled": "Annulé",
        "workOrders.saveWorkOrder": "Enregistrer l'ordre",
        "workOrders.selectMachine": "Sélectionner machine",
    },
    es: {
        "common.error": "Error",
        ...
        "equipment.openMaintenance": "Abrir mantenimiento",
        "equipment.openDocuments": "Abrir documentos",
        "equipment.openTimeline": "Abrir cronología",
        "equipment.qrScanner": "Escáner QR",
        "workOrders.assignedTo": "Asignar a",
        "workOrders.unassigned": "Sin asignar",
        "workOrders.dueDate": "Vencimiento",
        "workOrders.statusDraft": "Borrador",
        "workOrders.statusScheduled": "Planificado",
        "workOrders.statusPendingReview": "En revisión",
        "workOrders.statusCancelled": "Cancelado",
        "workOrders.saveWorkOrder": "Guardar orden",
        "workOrders.selectMachine": "Seleccionar máquina",
    },
};
...
export function LanguageProvider({ children }: { children: ReactNode }) {
    ...
    const t = (key: string): string => {
        ...
        return translationFallbacks[language]?.[key] || translationFallbacks.it?.[key] || key;
    };
