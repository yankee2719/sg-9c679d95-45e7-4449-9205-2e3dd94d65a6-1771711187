...
const translations: Record<Language, Record<string, string>> = {
    it: {
        ...
        // translation hardening batch - missing keys used in UI
        "common.error": "Errore",
        "common.saving": "Salvataggio...",

        "analytics.checklistExecTitle": "Esecuzioni checklist",
        "analytics.checklistExecRedirectDesc": "Le esecuzioni checklist sono state consolidate nella vista operativa aggiornata. Ti stiamo reindirizzando automaticamente.",

        "customers.quickActions": "Azioni rapide",
        "customers.errorUpdate": "Errore aggiornamento cliente",

        "documents.allCategories": "Tutte le categorie",
        "documents.allLanguages": "Tutte le lingue",
        "documents.catOther": "Altro",
        "documents.errorNoPath": "Percorso file non disponibile.",
        "documents.errorNoSignedUrl": "Impossibile generare il link al documento.",
        "documents.errorOpen": "Errore apertura documento",
        "documents.filters": "Filtri",
        "documents.kpiActive": "Documenti attivi",
        "documents.kpiLanguages": "Lingue",
        "documents.kpiLinked": "Collegati",
        "documents.kpiRecent": "Recenti",
        "documents.noResultsDesc": "Nessun documento corrisponde ai filtri attivi.",
        ...
        "equipment.accessDenied": "Accesso negato",
        "equipment.accessDeniedDesc": "La macchina non è disponibile nel contesto attivo.",
        "equipment.activeChecklists": "Checklist attive",
        "equipment.assignedCustomer": "Cliente assegnato",
        "equipment.assignmentContext": "Contesto assegnazione",
        "equipment.backToMachine": "Torna alla macchina",
        "equipment.createMachine": "Crea macchina",
        "equipment.created": "Macchina creata",
        "equipment.deleteConfirm": "Spostare la macchina nel cestino?",
        "equipment.docBestPracticesTitle": "Buone pratiche documentali",
        "equipment.docManagement": "Gestione documenti",
        "equipment.docTip1": "Carica sempre la versione più aggiornata del manuale.",
        "equipment.docTip2": "Mantieni separati manuali, schemi e certificati.",
        "equipment.docTip3": "Usa nomi file chiari e versionati.",
        "equipment.docTip4": "Collega i documenti direttamente alla macchina corretta.",
        "equipment.docsDesc": "Archivio tecnico collegato alla macchina.",
        "equipment.editMachine": "Modifica macchina",
        "equipment.editSubtitle": "Aggiorna i dati principali della macchina.",
        "equipment.errorNameRequired": "Inserisci il nome della macchina.",
        "equipment.errorUpdate": "Errore aggiornamento macchina",
        "equipment.fallbackName": "Macchina senza nome",
        "equipment.internalCode": "Codice interno",
        "equipment.invalidId": "ID macchina non valido.",
        "equipment.latestWorkOrders": "Ultimi work order",
        "equipment.loadError": "Errore caricamento macchina.",
        "equipment.machineContext": "Contesto macchina",
        "equipment.machineName": "Nome macchina",
        "equipment.mainData": "Dati principali",
        "equipment.maintenanceTitle": "Manutenzione",
        "equipment.moveToTrash": "Sposta nel cestino",
        "equipment.movedToTrash": "Macchina spostata nel cestino",
        "equipment.newSubtitle": "Inserisci i dati principali della nuova macchina.",
        "equipment.noChecklists": "Nessuna checklist collegata.",
        "equipment.noNotes": "Nessuna nota disponibile.",
        "equipment.noResults": "Nessuna macchina trovata.",
        "equipment.noWorkOrders": "Nessun work order collegato.",
        "equipment.notAssigned": "Non assegnata",
        "equipment.notFound": "Macchina non trovata",
        "equipment.notFoundDesc": "La macchina richiesta non esiste o non è disponibile.",
        "equipment.notes": "Note macchina",
        "equipment.notesDesc": "Informazioni operative e note contestuali.",
        "equipment.owner": "Proprietario",
        "equipment.ownerContext": "Contesto proprietario",
        "equipment.photo": "Foto macchina",
        "equipment.photoDesc": "Immagine principale della macchina.",
        "equipment.quickInfo": "Informazioni rapide",
        "equipment.showHiddenToo": "Mostra anche nascoste",
        "equipment.showOnlyVisible": "Mostra solo visibili",
        "equipment.timeline": "Timeline macchina",
        "equipment.timelineDesc": "Eventi, modifiche e cronologia operativa.",
        "equipment.updated": "Macchina aggiornata",

        "machines.redirectDesc": "Questa vista è stata consolidata nella pagina aggiornata delle macchine. Ti stiamo reindirizzando automaticamente.",

        "maintenance.detail": "Dettaglio manutenzione",
        "maintenance.edit": "Modifica manutenzione",
        "maintenance.editRedirectDesc": "La modifica dei piani manutentivi è stata consolidata nella vista aggiornata. Ti stiamo reindirizzando automaticamente.",
        "maintenance.editRedirectTitle": "Reindirizzamento modifica manutenzione",
        "maintenance.goTo": "Vai alla manutenzione",
        "maintenance.newRedirectDesc": "La creazione dei piani manutentivi è stata consolidata nella vista aggiornata. Ti stiamo reindirizzando automaticamente.",
        "maintenance.newTitle": "Nuovo piano manutentivo",
        "maintenance.redirectDesc": "Questa sezione è stata consolidata nella nuova area manutenzione. Ti stiamo reindirizzando automaticamente.",
        "maintenance.redirectTitle": "Reindirizzamento manutenzione",

        "manufacturers.added": "Costruttore aggiunto",
        "manufacturers.addressLabel": "Indirizzo",
        "manufacturers.countryLabel": "Paese",
        "manufacturers.deleted": "Costruttore eliminato",
        "manufacturers.editTitle": "Modifica costruttore",
        "manufacturers.empty": "Nessun costruttore",
        "manufacturers.emptyDesc": "Aggiungi i costruttori delle tue macchine.",
        "manufacturers.nameLabel": "Nome",
        "manufacturers.new": "Nuovo costruttore",
        "manufacturers.phoneLabel": "Telefono",
        "manufacturers.subtitle": "Anagrafica costruttori macchine",
        "manufacturers.title": "Costruttori",
        "manufacturers.updated": "Costruttore aggiornato",
        "manufacturers.websiteLabel": "Sito web",

        "plants.addLine": "Aggiungi linea",
        "plants.code": "Codice",
        "plants.customerOnly": "Questa sezione è disponibile nel contesto cliente.",
        "plants.errorLineNameRequired": "Inserisci il nome della linea.",
        "plants.line": "Linea",
        "plants.lineCodeLabel": "Codice linea",
        "plants.lineCreated": "Linea creata",
        "plants.lineCreatedDesc": "La nuova linea è stata aggiunta.",
        "plants.lineNameLabel": "Nome linea",
        "plants.lineNamePlaceholder": "Es. Linea triturazione",
        "plants.lines": "Linee",
        "plants.linesTitle": "Linee dello stabilimento",
        "plants.machinesPlaced": "Macchine posizionate",
        "plants.noLines": "Nessuna linea presente",
        "plants.noLinesDesc": "Aggiungi almeno una linea produttiva.",
        "plants.noMachinesDesc": "Le macchine assegnate a questo stabilimento compariranno qui.",
        "plants.notAvailable": "Stabilimento non disponibile nel contesto attivo.",
        "plants.plantsWithMachines": "Stabilimenti con macchine",
        "plants.unassigned": "Non assegnata",

        "scan.accessDenied": "Accesso negato",
        "scan.accessGranted": "Accesso consentito",
        "scan.error": "Si è verificato un errore",
        "scan.errorDesc": "Impossibile validare il QR code. Riprova.",
        "scan.noOfflineData": "Nessun dato offline disponibile",
        "scan.noOfflineDataDesc": "Sei offline e questo QR non è ancora stato memorizzato sul dispositivo.",
        "scan.offlineAccess": "Accesso offline consentito",
        "scan.offlineNote": "Dati salvati in locale, potrebbero non essere aggiornati.",
        "scan.reasonExpired": "Questo QR code è scaduto.",
        "scan.reasonGeneric": "Non hai i permessi per accedere a questa macchina.",
        "scan.reasonMaxScans": "Numero massimo di utilizzi raggiunto.",
        "scan.reasonRevoked": "Questo QR code è stato revocato.",
        "scan.redirecting": "Reindirizzamento alla macchina...",
        "scan.retry": "Riprova",
        "scan.validating": "Validazione QR in corso",
        "scan.wait": "Attendi un istante...",

        "trash.errorLoad": "Errore caricamento cestino",
        "trash.noCustomers": "Nessun cliente nel cestino.",
        "trash.noDocuments": "Nessun documento nel cestino.",
        "trash.noMachines": "Nessuna macchina nel cestino.",

        "users.active": "Attivi",
        "users.allRoles": "Tutti i ruoli",
        "users.allStatuses": "Tutti gli stati",
        "users.created": "Creato",
        "users.inactive": "Disattivi",
        ...
        "users.noResultsDesc": "Nessun utente corrisponde ai filtri attivi.",
        "users.organization": "Organizzazione",

        "workOrders.assignedTo": "Assegnato a",
        "workOrders.createDesc": "Compila i dati operativi per creare un nuovo ordine di lavoro.",
        "workOrders.createLoading": "Creazione ordine di lavoro...",
        "workOrders.createdAt": "Creato il",
        "workOrders.descriptionPlaceholder": "Descrivi attività, materiali, rischi o note operative.",
        "workOrders.dueDate": "Scadenza",
        "workOrders.errorCreate": "Errore creazione ordine di lavoro",
        "workOrders.errorInvalidMachine": "La macchina selezionata non è valida per il contesto attivo.",
        "workOrders.errorLoadPage": "Errore caricamento pagina work order.",
        "workOrders.errorNoOrg": "Organizzazione attiva non disponibile.",
        "workOrders.errorNoPlant": "Seleziona uno stabilimento.",
        "workOrders.errorSelectMachine": "Seleziona una macchina.",
        "workOrders.errorTitleRequired": "Inserisci il titolo del work order.",
        "workOrders.errorUpdate": "Errore aggiornamento work order",
        "workOrders.machineId": "ID macchina",
        "workOrders.noDescription": "Nessuna descrizione disponibile.",
        "workOrders.onlyAdminCreate": "Solo gli admin possono creare work order.",
        "workOrders.overdue": "In ritardo",
        "workOrders.permissionDenied": "Permesso negato",
        "workOrders.redirectDesc": "La creazione dei work order è stata consolidata nella pagina operativa aggiornata. Ti stiamo reindirizzando automaticamente.",
        "workOrders.saveWorkOrder": "Salva work order",
        "workOrders.selectMachine": "Seleziona macchina",
        "workOrders.statusCancelled": "Annullato",
        "workOrders.statusDraft": "Bozza",
        "workOrders.statusLabel": "Stato",
        "workOrders.statusPendingReview": "In revisione",
        "workOrders.statusScheduled": "Pianificato",
        "workOrders.titlePlaceholder": "Es. Sostituzione cinghia convogliatore",
        "workOrders.typeEmergency": "Emergenza",
        "workOrders.unassigned": "Non assegnato",
        "workOrders.updatedAt": "Aggiornato il",
