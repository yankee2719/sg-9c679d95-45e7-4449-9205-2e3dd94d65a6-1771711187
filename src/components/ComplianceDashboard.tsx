    ...
    if (error) {
        return (
            <div className={`bg-red-50 border border-red-200 rounded-lg p-6 ${className}`}>
                <p className="text-red-800">Errore nel caricamento dello stato compliance</p>
            </div>
        );
    }
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-amber-800">
                                    Per ottenere la certificazione CE è necessario caricare i {missingCount} {missingCount === 1 ? 'documento mancante' : 'documenti mancanti'}.
                                </p>
                            </div>
                        </div>
                    </div>
